...
- [Crumbz updates to 1.1 — what the first `update` of an edited kit met](./2026-09-16-crumbz-update-to-1-1.md) — the writer of Crumbz's CP-CAIRN-UPDATE-027, under ADR-028: a repair the release does not carry and no place to say so; the live view always on the reconcile list while a path runs; a pointer page never pristine the day after; a file unmanaged at one reading and edited at the next; a close skill pointing at a file no release installs; template sentences that read false where they land.
