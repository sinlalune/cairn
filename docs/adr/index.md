...
- [ADR-017 — the review movement](./ADR-017-the-review-movement.md) — accepted 2026-09-07; a unit has five movements, plan, change, self-review, review, verify; the review is the writer's own agent in a fresh context given only the diff and the two criteria of ADR-016, its findings and dispositions in a `#### Review` section the blocking rule `review` requires. Decisions Q6 and Q7, the owner's words quoted; the one answer of the page that adds a rule, the manifesto's test weighed.
