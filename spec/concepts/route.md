...
Two routes are named. Cairn 0.2 named four: `foundation` folded into `full`
with a documents-only write surface, and `emergency`, named and never
specified, was dropped rather than carried.
